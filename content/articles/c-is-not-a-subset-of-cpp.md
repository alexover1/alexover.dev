...
This code compiles in C, but _does not compile_ in C++!

## Postfix increment

There's a popular programmer joke about the name "C++." In both C _and_ C++,
...
Read more: [Compatibility of C and C++](https://en.wikipedia.org/wiki/Compatibility_of_C_and_C++)
